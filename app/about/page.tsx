...
export default function AboutPage() {
	...
	const values = [
		{
			...
			title: "Excellence",
			description:
				"We pursue engineering perfection in every foundation, ensuring structural integrity that exceeds specifications.",
		},
		{
			icon: Shield,
			title: "Integrity",
			description:
				"Honest communication, transparent processes, and standing behind our work with industry-leading quality standards.",
		},
		{
			icon: Lightbulb,
			title: "Innovation",
			description:
				"Embracing advanced geotechnical techniques and international-standard machinery for superior results.",
		},
		{
			icon: Leaf,
			title: "Safety",
			description:
				"Committed to zero-incident operations through effective safety management in all our underground works.",
		},
	];
	...
	const milestones = [
		{
			year: "2014",
			event: "V Infra Engineers founded in collaboration with SM Infra & HIIL",
		},
		{
			year: "2016",
			event: "Completed first major diaphragm wall project in Delhi NCR",
		},
		{
			year: "2018",
			event: "Expanded fleet with international-standard hydraulic rigs",
		},
		{ year: "2020", event: "Secured DMRC metro station projects with L&T" },
		{
			year: "2022",
			event: "Expanded to hospital, underpass, and commercial projects",
		},
		{
			year: "2024",
			event: "Grew to 100+ professionals with 50+ major projects completed",
		},
	];
						...
						<div className="relative">
							...
							<div
								...
								<p
									...
									&ldquo;Every foundation we build carries the weight
									of trust. Our job is to ensure it stands
									forever.&rdquo;
								</p>
								<p
						...
						<div>
							...
							<div
								...
								<p>
									...
									into Delhi NCR&apos;s most trusted underground
									construction company, with over 100 skilled
									professionals serving infrastructure and commercial
									clients across North India.
								</p>
								<p>
									Today, we&apos;re proud to have executed numerous
									large-scale projects, from metro stations to
									commercial basements and hospital foundations. Our
									core values remain unchanged: engineering excellence,
									precision execution, and complete client
									satisfaction.
								</p>
							</div>
			...
			<section
				...
				<div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
					...
					<p
						...
						style={{ color: `${currentTheme.colors.textOnDark}cc` }}>
						Join leading developers and infrastructure companies who trust
						V Infra Engineers for deep foundation solutions.
					</p>
					<Link
						href="/contact"
