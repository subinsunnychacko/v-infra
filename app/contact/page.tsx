  ...
  const faqs = [
    {
      ...
      answer: 'Project duration varies based on wall depth, length, and soil conditions. A typical diaphragm wall project may take 3-6 months. We\'ll provide a detailed timeline with your quote.',
    },
    {
      question: 'Do you offer free site assessments?',
      answer: 'Yes! We provide free site assessments and consultations. Our engineering team will visit your site, analyze soil conditions, and provide a detailed scope and estimate.',
    },
    {
      question: 'What equipment do you operate?',
      answer: 'We operate international-standard machinery including 4 hydraulic rigs, 3 hydraulic cranes (45-80MT), 6 crawler cranes (18-35MT), 2 crawler anchor rigs, and 20 polymer tanks.',
    },
    {
      question: 'What safety standards do you follow?',
      answer: 'Our goal is zero incidents through effective safety management. All injuries and illnesses are preventable. We investigate all incidents and near misses to prevent recurrence.',
    },
    {
      question: 'What depth can you achieve?',
      answer: 'We can construct diaphragm walls with thickness of 300mm to 1500mm, up to a depth of 50 meters. Our equipment handles even the most challenging soil conditions.',
    },
  ];
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          <div className="contact-hero-content max-w-3xl">
            ...
            >
              Ready to start your underground construction project? Fill out our quick form below and we&apos;ll 
              get back to you with a detailed project assessment within 24 hours.
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              {guarantees.map((item, index) => (
                ...
                >
                  <item.icon size={16} style={{ color: currentTheme.colors.secondary }} />
                  <span
                ...
                {contactInfo.map((item, index) => (
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      >
                        <item.icon size={24} style={{ color: currentTheme.colors.secondary }} />
                      </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="flex flex-wrap items-center justify-center gap-12">
            {['ISO Certified', 'HIIL Partnership', 'SM Infra Alliance', 'Safety Compliant', '50+ Major Projects'].map((badge, index) => (
              <div
                key={index}
              ...
              >
                <Shield size={20} style={{ color: currentTheme.colors.secondary }} />
                <span
