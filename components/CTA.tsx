...
const CTA = () => {
	...
	const contactOptions = [
		...
		},
		{
			...
			description: "Get a detailed cost breakdown for your project",
			action: "/contact",
			actionText: "Request Estimate",
			isLink: true,
		},
	];
			...
			<div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
				...
				<div className="cta-content text-center mb-16">
					...
					<p
						...
						Contact us for specialized deep foundation and diaphragm wall
						solutions. Our expert engineering team is ready to deliver
						precision underground construction for your project.
					</p>
					...
					<p
						...
						No obligation • Expert consultation • Free site assessment
						included
					</p>
				</div>
