      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="footer-animate">
            ...
            >
              Market leader for underground and deep foundations in Delhi NCR. 
              Engineering excellence, state-of-the-art equipment, and operational expertise since 2014.
            </p>
              ...
              {socialLinks.map((social) => (
                <a
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.color = currentTheme.colors.ctaText;
                  }}
                  onMouseLeave={(e) => {
          ...
          <div className="footer-animate">
            <h4
              className="font-heading text-lg font-semibold mb-6 text-white relative inline-block"
            >
              Quick Links
              <span
        ...
        >
          ...
          >
            © {new Date().getFullYear()} V Infra Engineers. All rights reserved.
          </p>
